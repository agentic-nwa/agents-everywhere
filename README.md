...
- **[Paperclip AI](https://paperclip.ing/)** — Open-source orchestration framework for teams of AI agents — assign goals, track work and cost, and coordinate coding agents like Claude Code as workers.
